    ...
    <div class="col-md-12">
        <div class="card card-default">
            <div class="card-header bg-info">
              <h3 class="card-title">FORM EDIT DATA STOK LOKER {{$data->nama_loker}}</h3>
                  ...
                  <div class="row">
                        <div class="col-md-12">
                              <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                    <select class="form-control select2" name="loker_id">
                                          @foreach ($loker as $item)
                                          <option value="{{$item->id}}" {{ $data->loker_id == $item->id ? 'selected' : '' }}>{{$item->nama_loker}}</option>
                                          @endforeach
                                          </select>
                                    </div>
                                    </div>
                              ...
                              <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                          ...
                                          <div class="col-sm-10">
                                          <textarea class="form-control" placeholder="Catatan tambahan.." name="catatan" rows="2">{{$data->catatan}}</textarea>
                                          </div>
                                    </div>
                              </div>
                        </div>
