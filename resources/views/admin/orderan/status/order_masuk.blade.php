  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title"><i class="far fa-clipboard"> DAFTAR ORDER MASUK (Belum Dikonfirmasi)</i></h3>
      </div>
      <!-- ./card-header -->
        ...
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr data-widget="expandable-table" aria-expanded="false">
              ...
              <td class="text-center"><span class="badge badge-secondary">Order Masuk</span></td>
              <td class="text-center">
                <a href="/lihat_orderan/detail/{{$item->id}}" class="btn btn-sm btn-info" title="Detail"><i class="fas fa-eye"></i></a>
                <a href="/orderan/konfirmasi/{{$item->id}}" class="btn btn-sm btn-success">
                   Konfirmasi Order <i class="fas fa-arrow-right"></i>
                </a>
              </td>
            </tr>
            ...
            @empty
            <tr>
              <td colspan="7" class="text-center py-4">Tidak ada order masuk</td>
            </tr>
            @endforelse
          </tbody>
        </table>
