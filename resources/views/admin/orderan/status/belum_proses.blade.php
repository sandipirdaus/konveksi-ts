  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title"><i class="far fa-clipboard"> DAFTAR ORDERAN BELUM DI PROSES</i></h3>
      </div>
      <!-- ./card-header -->
        ...
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr data-widget="expandable-table" aria-expanded="false">
              ...
              <td class="text-center"><span class="badge badge-primary">Belum Di Proses</span></td>
              <td class="text-center">
                <a href="/lihat_orderan/detail/{{$item->id}}" class="btn btn-sm btn-info" title="Detail"><i class="fas fa-eye"></i></a>
                <a href="/orderan/mulai_produksi/{{$item->id}}" class="btn btn-sm btn-success">
