        ...
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr data-widget="expandable-table" aria-expanded="false">
              ...
              <td class="text-center"><span class="badge badge-success">Orderan Selesai</span></td>
              <td class="text-center">
                <a href="/lihat_orderan/detail/{{$item->id}}" class="btn btn-sm btn-info" title="Detail"><i class="fas fa-eye"></i></a>
                <a href="/orderan/cetak_invoice/{{$item->id}}" target="_blank" class="btn btn-sm btn-success">
                   Lihat Invoice <i class="fas fa-arrow-right"></i>
                </a>
              </td>
            </tr>
