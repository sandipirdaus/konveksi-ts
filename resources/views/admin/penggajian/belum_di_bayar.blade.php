      ...
      <div class="card-body table-responsive">
        <table id="mytable" class="table table-bordered table-striped">
          ...
          <tr>
            ...
            <th class="text-center" style="width: 15%">Ubah Status / Opsi</th>
            @endif
          </tr>
          </thead>
          <tbody>
          ...
          <tr>
            ...
            <td class="text-center">
              <a href="/penggajian/ubah_status_pembayaran/{{$item->id}}" class="btn btn-success btn-sm"><i class="fas fa-check"></i> Sudah Dibayar</a>
